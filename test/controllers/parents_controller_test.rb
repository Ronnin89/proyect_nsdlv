...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { profile_id: @parent.profile_id, relation: @parent.relation } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { profile_id: @parent.profile_id, relation: @parent.relation } }
